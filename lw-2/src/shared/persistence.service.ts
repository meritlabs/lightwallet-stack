...
/**
 * @DISCUSS 1. do we REALLY need this class?
 *          2. is it a good idea to store plain keys and functions at same notation?
 *          3. do we need all this storage stuff? Ionic storage is a powerful tool that can use different types of storage, base on user device
 * */
@Injectable()
