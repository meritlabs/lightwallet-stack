...
var configBlob = fs.readFileSync('merit/appConfig.json', 'utf8');
...
/////////////////
console.log('Copying merit/appConfig.json' + ' to root');
...
// @todo investigate what is _EXTERNAL_SERVICES_CONFIG_LOCATION
// since we change confName from `coplay` to `merit`
try {
  var confName = 'merit'.toUpperCase();
...
// Push Notification
fs.copySync('merit/GoogleService-Info.plist', '../GoogleService-Info.plist');
fs.copySync('merit/google-services.json', '../google-services.json');

copyDir('merit/img', '../www/img/app');
copyDir('merit/sass', '../src/sass/app');
