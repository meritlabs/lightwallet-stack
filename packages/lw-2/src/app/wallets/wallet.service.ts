...
export class WalletService {
  ...
  public invalidateCache(wallet: IMeritWalletClient) {
  ...
  private processNewTxs(wallet: IMeritWalletClient, txs: any): Promise<Array<any>> {
    let configGet: any = this.configService.get();
  ...
  public decrypt(wallet: IMeritWalletClient, password:string): Promise<any> {
    return new Promise((resolve, reject) => {
      try {
