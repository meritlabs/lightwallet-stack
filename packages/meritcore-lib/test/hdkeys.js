...
var HDPrivateKey = meritcore.HDPrivateKey;
var HDPublicKey = meritcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = meritcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(meritcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(meritcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      meritcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = meritcore.PublicKey.fromPoint;
      meritcore.PublicKey.fromPoint = function() {
        meritcore.PublicKey.fromPoint = unstubbed;
