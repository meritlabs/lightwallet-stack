...
describe('Script', function() {
  ...
  describe('#isPublicKeyIn', function() {
    it('correctly identify scriptSig as a public key in', function() {
      ...
      var script = meritcore.Script.fromBuffer(scriptBuffer);
  ...
  describe('#isPushOnly', function() {
    it("should know these scripts are or aren't push only", function() {
      ...
      Script('OP_PUSHDATA1 5 0x1010101010')
        .isPushOnly()
        .should.equal(true);
      // like meritd, we regard OP_RESERVED as being "push only"
      Script('OP_RESERVED')
        .isPushOnly()
        .should.equal(true);
    });
  ...
  describe('#getSignatureOperationsCount', function() {
    // comes from meritd src/test/sigopcount_tests
    ...
    it('should handle P2SH-multisig-in scripts from utility', function() {
      ...
      var signature = meritcore.crypto.Signature.fromString('30060201FF0201FF');
