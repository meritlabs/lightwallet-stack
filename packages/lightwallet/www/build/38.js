...
SelectUnitModal = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'view-select-unit',template:/*ion-inline-start:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lightwallet/src/app/settings/select-unit/select-unit.html"*/'<ion-header>\n\n    <ion-navbar color="secondary">\n        <ion-title translate>Unit</ion-title>\n\n        <ion-buttons end>\n            <button ion-button (click)="cancel()" translate>\n                cancel\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n    <ion-list >\n        <ion-item *ngFor="let unit of availableUnits" [class.selected]="unit == currentUnit" (click)="select(unit)">\n            <ion-label>{{unit}}</ion-label>\n            <ion-icon name="checkmark" color="primary" item-right *ngIf="unit == currentUnit"></ion-icon>\n        </ion-item>\n    </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lightwallet/src/app/settings/select-unit/select-unit.html"*/,
    }),
