...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__export_wallet__ = __webpack_require__(887);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_qrcode__ = __webpack_require__(826);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_file__ = __webpack_require__(848);
...
$$moduleName$$Module = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__export_wallet__["a" /* ExportWalletView */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3_angular2_qrcode__["a" /* QRCodeModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__export_wallet__["a" /* ExportWalletView */]),
        ],
        providers: [
...
//# sourceMappingURL=export-wallet.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ExportWalletView; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_file__ = __webpack_require__(848);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_file_saver__ = __webpack_require__(888);
...
let ExportWalletView = class ExportWalletView {
    constructor(navCtrl, navParams, walletsService, alertController, persistanceService, appService, bwcService, toastCtrl, file, platform) {
    ...
    async download() {
        ...
        if (this.platform.is('ios')) {
            ...
            await __WEBPACK_IMPORTED_MODULE_6_file_saver__["saveAs"](blob, fileName);
        }
        this.toastCtrl.create({ message: `Wallet exported to ${fileName}`, cssClass: __WEBPACK_IMPORTED_MODULE_9_merit_core_toast_config__["a" /* ToastConfig */].CLASS_MESSAGE }).present();
    }
};
ExportWalletView = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'view-export-wallet',template:/*ion-inline-start:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lightwallet/src/app/wallets/export-wallet/export-wallet.html"*/'<ion-header>\n\n    <ion-navbar color="secondary">\n        <ion-title>Export Wallet</ion-title>\n    </ion-navbar>\n    <ion-toolbar color="secondary">\n        <ion-segment [(ngModel)]="segment">\n            <ion-segment-button value="file">\n                File/Text\n            </ion-segment-button>\n            <ion-segment-button value="code">\n                QR Code\n            </ion-segment-button>\n        </ion-segment>\n    </ion-toolbar>\n\n</ion-header>\n\n<ion-content>\n    <span  *ngIf="accessGranted">\n\n        <i class="wallet-icon default" [class.default]="!wallet.color">\n            <img src="assets/img/icon-wallet.svg"  [style.background]="wallet.color" >\n        </i>\n        <h2>{{wallet.name}}</h2>\n\n        <span *ngIf="segment == \'file\'">\n\n            <ion-item>\n                <ion-label>Set up password</ion-label>\n                <ion-input type="password" [(ngModel)]="formData.password" text-right></ion-input>\n            </ion-item>\n\n            <ion-item>\n                <ion-label>Repeat password</ion-label>\n                <ion-input type="password" [(ngModel)]="formData.repeatPassword" text-right></ion-input>\n            </ion-item>\n\n            <div class="control-buttons" margin>\n                <button ion-button [disabled]="!saveEnabled()" translate (click)="download()">\n                    Export\n                </button>\n            </div>\n\n        </span>\n        <span *ngIf="segment == \'code\'">\n\n            <qr-code *ngIf="qrcode" [value]="qrcode" [level]="M" [size]="220" [foreground]="\'#334\'"></qr-code>\n            <br>\n\n            From the destination device, go to Add wallet &gt; Import wallet and scan this QR code\n\n        </span>\n\n    </span>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lightwallet/src/app/wallets/export-wallet/export-wallet.html"*/,
    }),
...
//# sourceMappingURL=export-wallet.js.map
...
} else if (("function" !== "undefined" && __webpack_require__(889) !== null) && (__webpack_require__(890) !== null)) {
