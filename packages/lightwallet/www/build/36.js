...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_merit_transact_select_sending_option_select_sending_option__ = __webpack_require__(865);
...
SelectSendingOptionModal = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'view-select-sending-option',template:/*ion-inline-start:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lightwallet/src/app/transact/select-sending-option/select-sending-option.html"*/'<ion-header>\n\n    <ion-navbar color="secondary">\n        <ion-title>Select Sending Option</ion-title>\n        <ion-buttons end>\n            <button ion-button (click)="cancel()" translate>\n                cancel\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n    <span *ngIf="sendingOptions">\n        <button ion-item *ngFor="let sendingOption of sendingOptions" [class.selected]="selectedSendingOption.label == sendingOption.label" (click)="select(sendingOption)">\n            <h2 translate>\n                {{sendingOption.label}}\n            </h2>\n        </button>\n    </span>\n\n\n</ion-content>'/*ion-inline-end:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lightwallet/src/app/transact/select-sending-option/select-sending-option.html"*/,
    }),
