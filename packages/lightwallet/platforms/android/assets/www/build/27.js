...
SelectColorView = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'view-select-color',template:/*ion-inline-start:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lw-2/src/app/wallets/select-color/select-color.html"*/'<ion-header>\n\n    <ion-navbar color="secondary">\n        <ion-title>Select Wallet Color</ion-title>\n        <ion-buttons end>\n            <button ion-button (click)="cancel()" translate>\n                cancel\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <ion-list>\n        <button ion-item *ngFor="let color of availableColors" [class.selected]="color.hex == selectedColorHex" (click)="select(color)">\n            <ion-label>{{color.name}}</ion-label>\n            <ion-label item-right text-right>\n                <i class="wallet-icon">\n                    <img src="assets/img/icon-wallet.svg"  [style.background]="color.hex">\n                </i>\n            </ion-label>\n        </button>\n    </ion-list>\n\n</ion-content>\n'/*ion-inline-end:"/Users/adilwali/Development/src/github.com/meritlabs/lightwallet-stack/packages/lw-2/src/app/wallets/select-color/select-color.html"*/,
    }),
