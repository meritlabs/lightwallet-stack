    ...
    if (!this.copied) {
      this.alertController
        .create({
          ...
          message:
            "Have you written your phrase down? You can do it later on wallet export page, but we strongly recommend to do it now so you won't loose access to your Merit",
          buttons: [{ text: 'Cancel', role: 'cancel' }, { text: 'Ok', handler: this.toTransactView.bind(this) }],
        })
        .present();
    } else {
      this.toTransactView();
