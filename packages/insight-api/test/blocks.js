...
describe('Blocks', function() {
  describe('/blocks/:blockHash route', function() {
    ...
    var meritcoreBlock = meritcore.Block.fromBuffer(
      new Buffer(blocks['0000000000000afa0c3c0afd450c793a1e300ec84cbe9555166e06132f19a8f7'], 'hex'),
    );

    var node = {
      log: sinon.stub(),
      getBlock: sinon.stub().callsArgWith(1, null, meritcoreBlock),
      services: {
        meritd: {
          getBlockHeader: sinon
            .stub()
            .callsArgWith(1, null, blockIndexes['0000000000000afa0c3c0afd450c793a1e300ec84cbe9555166e06132f19a8f7']),
    ...
    it('block pool info should be correct', function(done) {
      var block = meritcore.Block.fromString(
        blocks['000000000000000004a118407a4e3556ae2d5e882017e7ce526659d8073f13a4'],
      );
      var node = {
        log: sinon.stub(),
        ...
        services: {
          meritd: {
            getBlockHeader: sinon
              .stub()
              .callsArgWith(1, null, blockIndexes['000000000000000004a118407a4e3556ae2d5e882017e7ce526659d8073f13a4']),
            isMainChain: sinon.stub().returns(true),
            height: 534092,
          },
        },
  ...
  describe('/blocks route', function() {
    ...
    stub
      ...
      .callsArgWith(
        1,
        null,
        new Buffer(blocks['000000000008fbb2e358e382a6f6948b2da24563bba183af447e6e2542e8efc7'], 'hex'),
      );
    stub
      .onSecondCall()
      .callsArgWith(
        1,
        null,
        new Buffer(blocks['00000000000006bd8fe9e53780323c0e85719eca771022e1eb6d10c62195c441'], 'hex'),
      );
