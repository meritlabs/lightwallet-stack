angular.module('insight').run([
  ...
  function(gettextCatalog) {
    ...
    gettextCatalog.setStrings('de_DE', {
      ...
      '<strong>insight</strong>  is an <a href="http://live.insight.is/" target="_blank">open-source Merit blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by meritd RPC.  Check out the <a href="https://github.com/bitpay/insight-ui" target="_blank">source code</a>.':
        '<strong>insight</strong> ist ein <a href="http://live.insight.is/" target="_blank">Open Source Merit Blockchain Explorer</a> mit vollständigen REST und Websocket APIs um eigene Wallets oder Applikationen zu implementieren. Hierbei werden fortschrittlichere Abfragen der Blockchain ermöglicht, bei denen die RPC des Meritd nicht mehr ausreichen. Der aktuelle <a href="https://github.com/bitpay/insight-ui" target="_blank">Quellcode</a> ist auf Github zu finden.',
      '<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.':
        '<strong>insight</strong> befindet sich aktuell noch in der Entwicklung. Bitte sende alle gefundenen Fehler (Bugs) und Feedback zur weiteren Verbesserung an unseren <a href="https://github.com/bitpay/insight-ui/issues" target="_blank">Github Issue Tracker</a>.',
      About: 'Über insight',
      Address: 'Adresse',
      Age: 'Alter',
      'Application Status': 'Programmstatus',
      'Best Block': 'Bester Block',
      'Merit node information': 'Merit-Node Info',
      Block: 'Block',
      'Block Reward': 'Belohnung',
      Blocks: 'Blöcke',
      'Bytes Serialized': 'Serialisierte Bytes',
      "Can't connect to meritd to get live updates from the p2p network. (Tried connecting to meritd at {{host}}:{{port}} and failed.)":
        'Es ist nicht möglich mit Meritd zu verbinden um live Aktualisierungen vom P2P Netzwerk zu erhalten. (Verbindungsversuch zu meritd an {{host}}:{{port}} ist fehlgeschlagen.)',
      "Can't connect to insight server. Attempting to reconnect...":
        'Keine Verbindung zum insight-Server möglich. Es wird versucht die Verbindung neu aufzubauen...',
      "Can't connect to internet. Please, check your connection.":
        'Keine Verbindung zum Internet möglich, bitte Zugangsdaten prüfen.',
      ...
      'Last Block Hash (Meritd)': 'Letzter Hash (Meritd)',
    ...
    gettextCatalog.setStrings('es', {
      ...
      '<strong>insight</strong>  is an <a href="http://live.insight.is/" target="_blank">open-source Merit blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by meritd RPC.  Check out the <a href="https://github.com/bitpay/insight-ui" target="_blank">source code</a>.':
        '<strong>insight</strong>  es un <a href="http://live.insight.is/" target="_blank">explorador de bloques de Merit open-source</a> con un completo conjunto de REST y APIs de websockets que pueden ser usadas para escribir monederos de Merits y otras aplicaciones que requieran consultar un explorador de bloques.  Obtén el código en <a href="http://github.com/bitpay/insight" target="_blank">el repositorio abierto de Github</a>.',
      '<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.':
        '<strong>insight</strong> esta en desarrollo aún, por ello agradecemos que nos reporten errores o sugerencias para mejorar el software. <a href="https://github.com/bitpay/insight-ui/issues" target="_blank">Github issue tracker</a>.',
      About: 'Acerca de',
      Address: 'Dirección',
      Age: 'Edad',
      'Application Status': 'Estado de la Aplicación',
      'Best Block': 'Mejor Bloque',
      'Merit node information': 'Información del nodo Merit',
      Block: 'Bloque',
      'Block Reward': 'Bloque Recompensa',
      Blocks: 'Bloques',
      'Bytes Serialized': 'Bytes Serializados',
      "Can't connect to meritd to get live updates from the p2p network. (Tried connecting to meritd at {{host}}:{{port}} and failed.)":
        'No se pudo conectar a meritd para obtener actualizaciones en vivo de la red p2p. (Se intentó conectar a meritd de {{host}}:{{port}} y falló.)',
      "Can't connect to insight server. Attempting to reconnect...":
        'No se pudo conectar al servidor insight. Intentando re-conectar...',
      "Can't connect to internet. Please, check your connection.":
        'No se pudo conectar a Internet. Por favor, verifique su conexión.',
      Complete: 'Completado',
      ...
      'Last Block Hash (Meritd)': 'Último Bloque Hash (Meritd)',
    ...
    gettextCatalog.setStrings('ja', {
      ...
      '<strong>insight</strong>  is an <a href="http://live.insight.is/" target="_blank">open-source Merit blockchain explorer</a> with complete REST and websocket APIs that can be used for writing web wallets and other apps  that need more advanced blockchain queries than provided by meritd RPC.  Check out the <a href="https://github.com/bitpay/insight-ui" target="_blank">source code</a>.':
        '<strong>insight</strong>は、meritd RPCの提供するものよりも詳細なブロックチェインへの問い合わせを必要とするウェブウォレットやその他のアプリを書くのに使える、完全なRESTおよびwebsocket APIを備えた<a href="http://live.insight.is/" target="_blank">オープンソースのビットコインブロックエクスプローラ</a>です。<a href="https://github.com/bitpay/insight-ui" target="_blank">ソースコード</a>を確認',
      '<strong>insight</strong> is still in development, so be sure to report any bugs and provide feedback for improvement at our <a href="https://github.com/bitpay/insight/issues" target="_blank">github issue tracker</a>.':
        '<strong>insight</strong>は現在開発中です。<a href="https://github.com/bitpay/insight/issues" target="_blank">githubのissueトラッカ</a>にてバグの報告や改善案の提案をお願いします。',
      About: 'はじめに',
      Address: 'アドレス',
      Age: '生成後経過時間',
      ...
      'Best Block': '最良ブロック',
      'Merit comes with a way of signing arbitrary messages.':
        'Meritには任意のメッセージを署名する昨日が備わっています。',
      'Merit node information': 'Meritノード情報',
      Block: 'ブロック',
      'Block Reward': 'ブロック報酬',
      Blocks: 'ブロック',
      ...
      "Can't connect to meritd to get live updates from the p2p network. (Tried connecting to meritd at {{host}}:{{port}} and failed.)":
        'P2Pネットワークからライブ情報を取得するためにmeritdへ接続することができませんでした。({{host}}:{{port}} への接続を試みましたが、失敗しました。)',
      "Can't connect to insight server. Attempting to reconnect...":
        'insight サーバに接続できません。再接続しています...',
      "Can't connect to internet. Please, check your connection.":
        'インターネットに接続できません。コネクションを確認してください。',
      Complete: '完了',
      Confirmations: '検証数',
      Conn: '接続数',
      ...
      Input: '入力',
      'Last Block': '直前のブロック',
      'Last Block Hash (Meritd)': '直前のブロックのハッシュ値 (Meritd)',
      ...
      'The message is verifiably from {{verification.address}}.':
        'メッセージは{{verification.address}}により検証されました。',
      ...
      'This form can be used to broadcast a raw transaction in hex format over\n        the Merit network.':
        'このフォームでは、16進数フォーマットの生のトランザクションをMeritネットワーク上に配信することができます。',
      'This form can be used to verify that a message comes from\n        a specific Merit address.':
        'このフォームでは、メッセージが特定のMeritアドレスから来たかどうかを検証することができます。',
      'Time Offset': '時間オフセット',
      Timestamp: 'タイムスタンプ',
      Today: '今日',
      'Total Amount': 'Merit総量',
      'Total Received': '総入金額',
      'Total Sent': '総送金額',
      ...
      'Transaction succesfully broadcast.<br>Transaction id: {{txid}}':
        'トランザクションの配信に成功しました。<br>トランザクションID: {{txid}}',
      ...
      '<span class="glyphicon glyphicon-warning-sign"></span> (Orphaned)':
        '<span class="glyphicon glyphicon-warning-sign"></span> (孤立したブロック)',
      '<span class="glyphicon glyphicon-warning-sign"></span> Incoherence in levelDB detected: {{vin.dbError}}':
        '<span class="glyphicon glyphicon-warning-sign"></span> Incoherence in levelDB detected: {{vin.dbError}}',
