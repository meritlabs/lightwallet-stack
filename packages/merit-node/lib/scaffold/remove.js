...
/**
 * Will remove a service from merit-node.json
...
/**
 * Will remove the Node.js service and from the merit-node configuration.
 * @param {String} options.cwd - The current working directory
 * @param {String} options.dirname - The merit-node configuration directory
