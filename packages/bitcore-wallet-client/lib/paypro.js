...
PayPro._createPayment = function(merchant_data, rawTx, refundAddr, amountSatoshis) {
  ...
  var refund_outputs = this._getPayProRefundOutputs(refundAddr, amountSatoshis);
  if (refund_outputs)
...
PayPro.send = function(opts, cb) {
  ...
  var payment = PayPro._createPayment(opts.merchant_data, opts.rawTx, opts.refundAddr, opts.amountSatoshis);
